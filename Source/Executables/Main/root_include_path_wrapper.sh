...
# matter how early.
#
# Uses Bazel's own runfiles library (rules_shell, via use_bash_launcher = True on this target
# -- see BUILD.bazel) to locate both the real binary and _CROOTData.hh: the release archive
